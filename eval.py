...
from utils.utils_metrics import evaluteTop1_5, calculate_metric
...
if __name__ == "__main__":
    ...
    accuracy, sensitivity, specificity, auc = calculate_metric(classfication, lines, metrics_out_path)
    # Accuracy
